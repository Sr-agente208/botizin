...
let Nreg = JSON.parse(fs.readFileSync('./SRC/rg/Json/registros.json'));

const registro = JSON.parse(fs.readFileSync('./SRC/rg/Json/registros.json'))
/////REGISTRO
 const AddReg = ( sender, nombre) => {
  ...
  rep : 0}
            registro.push(obj)
            fs.writeFileSync('./SRC/rg/Json/registros.json', JSON.stringify(registro, null , 2 )+'\n')
        }
